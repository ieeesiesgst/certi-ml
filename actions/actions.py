...
courseInfo = {
    ...
    "ml": "74 percent of Indian business heads believe that Artificial Intelligence (AI) can augment economic growth, according to a recent PwC India report. With this growth and demand for skilled talent in mind, IEEE SIESGST has designed the one-month Certificate Program in Machine Learning & AI with Python\n- Durtion: 1 month (self placed)\n- Cost: Free\n- Faculty: Mr. X",
